...
if __name__ == "__main__":
    ...
    parser.add_argument('-ms_pat', metavar='ms_pat',help='Generic name of the directories with mu gradient',default='mus_force_*')
    parser.add_argument('-mf_pat', metavar='mf_pat',help='Generic name of the directories with p gradient',default='muf_force_*')
