...
def number_properties(directory,files):
    """
...
def build_times(directories,files=["statistics.dat","thermo.dat"]):
    """
...
def construxr_times(directories,files=["statistics.dat","thermo.dat"]):
    """
