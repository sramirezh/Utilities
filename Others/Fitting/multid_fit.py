...
def test_prediction(popt,variables,z,poly):
    """
    Creates the test prediction for a mesh
    Args:
...
results=test_prediction(popt,variables_e,z_e, poly_e)


ax2.scatter(x_e, y_e, results[:,1], zdir='z',label="Fitting",color='black')
#    
#Creating the surface
