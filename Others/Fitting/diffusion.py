...
This script is to predict the diffusion coefficient data from the fitted coefficients in the SI 
@author: simon
"""
import numpy as np
...
# Input parameters
# =============================================================================
coefficient_file = 'fit_coefficients_diffusion_coefficient_liquid_rc2.0.txt'
values_file = 'diffusion_coefficient_liquid_rc2.0.txt'
